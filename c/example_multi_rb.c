 ...
 */
 ...
 #define DEFAULT_NUM_PAIRS 4       // Number of producer-consumer pairs
 ...
 int main(int argc, char* argv[]) {
     ...
     double total_throughput = 0.0, total_spin_time = 0.0, total_service_time = 0.0;
     double total_latency = 0.0, total_running_time = 0.0;
 
     // Gather statistics from all consumers
     for (int i = 0; i < num_pairs; i++) {
     ...
     // Calculate averages
     double avg_latency = total_latency / num_pairs;
